...
// tools library
if (!class_exists('kitEventToolsLibrary'))
  require_once(WB_PATH.'/modules/kit_event/class.tools.php');
global $kitEventTools;
if (!is_object($kitEventTools))
  $kitEventTools = new kitEventToolsLibrary();
